...
export const Information = () => {
  return (
    <div className="w-[350px] bg-tropicalblue-100 py-[2.25rem] flex flex-col justify-between rounded-[1.25rem] h-[90vh] px-[2.45rem]">
      <h3 className="text-titleSmall text-tropicalblue-700 mb-[3.5rem]">인적사항</h3>
      <div>
