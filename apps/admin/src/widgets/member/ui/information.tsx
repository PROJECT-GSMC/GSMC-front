...
export const Information = ({ student }: InformationProps) => {
  ...
  return (
    <div className="flex flex-col h-full bg-tropicalblue-100 rounded-[1.25rem] px-[2.45rem] py-[2.25rem] justify-between ">
      <h3 className="text-titleSmall text-tropicalblue-700 md:mb-[3.5rem]">
        인적사항
      </h3>
      <div>
        ...
        <div className="text-tropicalblue-700 mt-[1.25rem] md:mb-[2.56rem] mb-[0.5rem] text-titleMedium h-[32rem] max-md:h-[10rem] flex items-center justify-center rounded-[0.75rem] bg-white">
